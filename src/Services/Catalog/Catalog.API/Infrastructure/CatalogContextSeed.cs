namespace Microsoft.eShopOnContainers.Services.Catalog.API.Infrastructure
{
  ...
  public class CatalogContextSeed
  {
    ...
    {
      string csvFileCatalogBrands = Path.Combine(contentRootPath, "Setup", "PeruvianRestaurantCatalogBrands.csv");
    ...
    {
      string csvFileCatalogTypes = Path.Combine(contentRootPath, "Setup", "PeruvianRestaurantCatalogTypes.csv");
    ...
    {
      string csvFileCatalogItems = Path.Combine(contentRootPath, "Setup", "PeruvianRestaurantCatalogItems.csv");
    ...
    private void GetCatalogItemPictures(string contentRootPath, string picturePath)
    {
      if (picturePath != null)
      {
        ...
        string zipFileCatalogItemPictures = Path.Combine(contentRootPath, "Setup", "PeruvianRestaurantCatalogItems.zip");
